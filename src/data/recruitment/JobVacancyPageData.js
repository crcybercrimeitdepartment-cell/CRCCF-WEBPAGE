...
export const jobListings = [
  ...
  },
  {
    ...
    {
    id: "CRCCF-IT-PYFS-2026-001",
    jobTitle: "Junior Python Full Stack Developer",
    jobCode: "CRCCF-IT-PYFS-2026-001",
    department: "IT Department",
    positionLevel: "Entry Level",
    status: "OPEN",
    shortDescription: "Develop and maintain full-stack web applications using Python, FastAPI, React.js, Next.js, Angular, REST APIs, MySQL, Git, and modern deployment platforms.",
    location: "Multiple Locations",
    openPositions: 110,
    applicationLastDate: "September 30, 2026",
    employmentType: "Permanent",
    ...
    salary: "₹3.20L – ₹6.50L / annum",
    tags: ["Python", "Full Stack", "FastAPI", "React.js"],
  },
  {
    id: "CRCCF-IT-QA-ENG-2026-001",
    jobTitle: "QA Engineer",
    jobCode: "CRCCF-IT-QA-ENG-2026-001",
    department: "IT Department",
    positionLevel: "Entry Level",
    status: "OPEN",
    shortDescription: "Perform software testing, defect tracking, API testing, database validation, regression testing, and quality assurance activities across the SDLC.",
    location: "Multiple Locations",
    openPositions: 30,
    applicationLastDate: "September 30, 2026",
    employmentType: "Permanent",
    ...
    experience: "0–2 Years",
    salary: "₹3.20L – ₹6.50L / annum",
    tags: ["QA", "Manual Testing", "API Testing", "SQL"],
  },
  {
    id: "CRCCF-IT-MAD-2026-001",
    jobTitle: "Mobile Application Developer",
    jobCode: "CRCCF-IT-MAD-2026-001",
    department: "IT Department",
    positionLevel: "Entry Level",
    status: "OPEN",
    shortDescription: "Develop cross-platform mobile applications using Flutter, Dart, React Native, JavaScript, TypeScript, REST APIs, and Android/iOS technologies.",
    location: "Multiple Locations",
    openPositions: 110,
    applicationLastDate: "September 30, 2026",
    employmentType: "Permanent",
    ...
    experience: "0–2 Years",
    salary: "₹3.20L – ₹6.50L / annum",
    tags: ["Flutter", "Dart", "React Native", "Mobile Development"],
  },
  {
    id: "CRCCF-DES-GD-2026-001",
    jobTitle: "Graphic Designer",
    jobCode: "CRCCF-DES-GD-2026-001",
    department: "Design & Creative Department",
    positionLevel: "Entry Level",
    status: "OPEN",
    shortDescription: "Develop creative concepts and produce high-quality visual materials for digital and print media using Adobe Creative Suite, Figma, and Canva.",
    location: "Multiple Locations",
    openPositions: 10,
    applicationLastDate: "September 30, 2026",
    employmentType: "Permanent",
    ...
    expectedJoining: "October 01, 2026",
    experience: "0–2 Years",
    salary: "₹2.40L – ₹4.50L / annum",
    tags: ["Photoshop", "Illustrator", "InDesign", "Figma", "Canva"],
  },
  {
    id: "CRCCF-IT-JDEVOPS-2026-001",
    jobTitle: "Junior DevOps Engineer",
    jobCode: "CRCCF-IT-JDEVOPS-2026-001",
    department: "IT Department",
    positionLevel: "Entry Level",
    status: "OPEN",
    shortDescription: "Support software deployment, CI/CD pipelines, Docker, Kubernetes, AWS/Azure cloud infrastructure, and automation.",
    location: "Multiple Locations",
    openPositions: 10,
    applicationLastDate: "September 30, 2026",
    employmentType: "Permanent",
    ...
    expectedJoining: "October 01, 2026",
    experience: "0–2 Years",
    salary: "₹2.80L – ₹3.50L / annum",
    tags: ["DevOps", "Docker", "Kubernetes", "AWS", "CI/CD"],
  },
  {
    id: "CRCCF-IT-JSECURITY-2026-001",
    jobTitle: "Cyber Security Engineer",
    jobCode: "CRCCF-IT-JSECURITY-2026-001",
    department: "Cyber Security Department",
    positionLevel: "Entry Level",
    status: "OPEN",
    shortDescription: "Implement and monitor security controls, vulnerability assessments, threat detection, incident response, and network security.",
    location: "Multiple Locations",
    openPositions: 110,
    applicationLastDate: "September 30, 2026",
    employmentType: "Permanent",
    ...
    expectedJoining: "October 01, 2026",
    experience: "0–2 Years",
    salary: "₹2.45L – ₹5.67L / annum",
    tags: ["Cyber Security", "Network Security", "Vulnerability", "Incident Response"],
  },
  {
    id: "CRCCF-IT-JCCIO-2026-001",
    jobTitle: "Cyber Crime Investigation Officer",
    jobCode: "CRCCF-IT-JCCIO-2026-001",
    department: "Cyber Crime Investigation Department",
    positionLevel: "Entry Level",
    status: "OPEN",
    shortDescription: "Conduct investigations involving digital systems, forensic evidence collection, device examination, and cyber incident analysis.",
    location: "Multiple Locations",
    openPositions: 110,
    applicationLastDate: "September 30, 2026",
    employmentType: "Permanent",
    ...
    experience: "0–2 Years",
    salary: "₹2.45L – ₹5.67L / annum",
    tags: ["Digital Forensics", "Investigation", "Evidence", "Cyber Crime"],
  },
  {
    id: "CRCCF-IT-AIML-2026-001",
    jobTitle: "AI/ML Engineer",
    jobCode: "CRCCF-IT-AIML-2026-001",
    department: "IT Department",
    positionLevel: "Entry Level",
    status: "OPEN",
    shortDescription: "Develop machine learning, deep learning, GenAI, LLMs, NLP, and Computer Vision solutions for real-world enterprise applications.",
    location: "Multiple Locations",
    openPositions: 110,
    applicationLastDate: "September 30, 2026",
    employmentType: "Permanent",
    ...
    expectedJoining: "October 01, 2026",
    experience: "0–2 Years",
    salary: "₹2.40L – ₹4.20L / annum",
    tags: ["AI/ML", "Python", "Deep Learning", "LLMs", "NLP"],
  },
  {
    id: "CRCCF-IT-DANALYST-2026-001",
    jobTitle: "Data Analyst",
    jobCode: "CRCCF-IT-DANALYST-2026-001",
    department: "IT Department",
    positionLevel: "Entry Level",
    status: "OPEN",
    shortDescription: "Extract, process, and analyze data to create Power BI/Tableau dashboards, SQL analytics, and business insights.",
    location: "Multiple Locations",
    openPositions: 30,
    applicationLastDate: "September 30, 2026",
    employmentType: "Permanent",
    ...
    expectedJoining: "October 01, 2026",
    experience: "0–2 Years",
    salary: "₹2.20L – ₹3.20L / annum",
    tags: ["SQL", "Excel", "Power BI", "Tableau", "Data Analysis"],
  },
];
