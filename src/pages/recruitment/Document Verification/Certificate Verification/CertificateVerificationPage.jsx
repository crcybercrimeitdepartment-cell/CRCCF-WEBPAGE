...
import { 
    User, Phone, Mail, Briefcase, Hash, CheckCircle, ArrowLeft, Search, ShieldAlert, Building, FileText, AtSign, UserCheck, Award
} from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="bg-white/60 backdrop-blur-xl border-b border-slate-100/80 p-8 sm:px-12 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 relative z-10">
                            <div className="flex items-center space-x-6">
                                <img src={certificateDetails.certificatePhotoPreview} alt="Preview" className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl object-cover shadow-sm ring-2 ring-white" style={{ borderColor: themeColor }} />
                                <div>
                                    <div className="flex flex-wrap items-center gap-4 mb-2">
                                        <h2 className="text-3xl sm:text-4xl font-black text-slate-800 tracking-tight">Certificate Details</h2>
                                        <span 
                        ...
                        <div className="p-8 sm:p-12 bg-slate-50/30 relative z-10">
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <InfoField icon={FileText} label="Sl No" value={certificateDetails.slNo} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Certificate Holder Name" value={certificateDetails.certificateHolderName} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Father's Name" value={certificateDetails.fatherSName} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Date of Birth" value={certificateDetails.dateOfBirth} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Gender" value={certificateDetails.gender} themeColor={themeColor} />
                                    ...
                                    <InfoField icon={FileText} label="Institution Name" value={certificateDetails.institutionName} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Board / University" value={certificateDetails.boardUniversity} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Registration Number" value={certificateDetails.registrationNumber} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Certificate Number" value={certificateDetails.certificateNumber} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Issue Date" value={certificateDetails.issueDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Passing Year" value={certificateDetails.passingYear} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Grade / Marks" value={certificateDetails.gradeMarks} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Certificate Validity" value={certificateDetails.certificateValidity} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Issuing Authority" value={certificateDetails.issuingAuthority} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Mobile Number" value={certificateDetails.mobileNumber} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Email ID" value={certificateDetails.emailId} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Address" value={certificateDetails.address} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Certificate Status" value={certificateDetails.certificateStatus} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Verification Date" value={certificateDetails.verificationDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Verified By" value={certificateDetails.verifiedBy} themeColor={themeColor} />
