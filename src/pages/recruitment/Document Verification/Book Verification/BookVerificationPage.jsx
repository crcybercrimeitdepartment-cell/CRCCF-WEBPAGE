                        ...
                        <div className="bg-white/60 backdrop-blur-xl border-b border-slate-100/80 p-8 sm:px-12 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 relative z-10">
                            <div className="flex items-center space-x-6">
                                <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl flex items-center justify-center shadow-sm ring-2 ring-white" style={{ backgroundColor: `${themeColor}15`, borderColor: themeColor }}>
                                    <Book size={40} style={{ color: themeColor }} />
                                </div>
                                <div>
                        ...
                        <div className="p-8 sm:p-12 bg-slate-50/30 relative z-10">
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                    ...
                                    <InfoField icon={FileText} label="Modules" value={bookDetails.modules} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="No Of Chapters" value={bookDetails.noOfChapters} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Paragraph" value={bookDetails.paragraph} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="No Of Characters" value={bookDetails.noOfCharacters} themeColor={themeColor} />
                                    ...
                                    <InfoField icon={Mail} label="Publisher Email" value={bookDetails.publisherEmail} themeColor={themeColor} />
                                    <InfoField icon={Phone} label="Publisher Mobile" value={bookDetails.publisherMobile} themeColor={themeColor} />
                                    ...
                                    <InfoField icon={UserCheck} label="Verified By" value={bookDetails.verifiedBy} themeColor={themeColor} />
                                </div>
                            </div>
                        </div>
                    </motion.div>
