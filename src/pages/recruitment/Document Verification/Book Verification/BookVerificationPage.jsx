                    ...
                    >
                        <div className="bg-white p-8 sm:p-10 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] w-full max-w-md border border-slate-100">
                            ...
                            <form onSubmit={handleVerify} className="space-y-5">
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Book Name / Title</label>
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">ISBN Number</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                            <FileText size={18} className="text-slate-400" />
                                        </div>
                    ...
                    >
                        ...
                        <div className="bg-white/60 backdrop-blur-xl border-b border-slate-100/80 p-8 sm:px-12 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 relative z-10">
                            <div className="flex items-center space-x-6">
                                <img src={bookDetails.bookCoverPreview} alt="Preview" className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl object-cover shadow-sm ring-2 ring-white" style={{ borderColor: themeColor }} />
                                <div>
                                    <div className="flex flex-wrap items-center gap-4 mb-2">
                                        <h2 className="text-3xl sm:text-4xl font-black text-slate-800 tracking-tight">Book Details</h2>
                                        <span 
                        ...
                        <div className="p-8 sm:p-12 bg-slate-50/30 relative z-10">
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <InfoField icon={FileText} label="Sl No" value={bookDetails.slNo} themeColor={themeColor} />
                                    ...
                                    <InfoField icon={FileText} label="Author Name" value={bookDetails.authorName} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Co-Author Name" value={bookDetails.coAuthorName} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Publisher Name" value={bookDetails.publisherName} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Edition" value={bookDetails.edition} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="ISBN Number" value={bookDetails.isbnNumber} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Book Type" value={bookDetails.bookType} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Category" value={bookDetails.category} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Language" value={bookDetails.language} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Publication Date" value={bookDetails.publicationDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Number of Pages" value={bookDetails.numberOfPages} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Volume Number" value={bookDetails.volumeNumber} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Copyright Holder" value={bookDetails.copyrightHolder} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Copyright Year" value={bookDetails.copyrightYear} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Registration Number" value={bookDetails.registrationNumber} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Publisher Address" value={bookDetails.publisherAddress} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Publisher Email" value={bookDetails.publisherEmail} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Publisher Mobile" value={bookDetails.publisherMobile} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Book Status" value={bookDetails.bookStatus} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Verification Date" value={bookDetails.verificationDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Verified By" value={bookDetails.verifiedBy} themeColor={themeColor} />
