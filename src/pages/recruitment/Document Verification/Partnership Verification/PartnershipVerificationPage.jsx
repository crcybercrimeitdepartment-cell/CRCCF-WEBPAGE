...
import { 
    User, Phone, Mail, Briefcase, Hash, CheckCircle, ArrowLeft, Search, ShieldAlert, Building, FileText, AtSign, UserCheck, Handshake
} from 'lucide-react';
import { partnershipDetails } from './partnershipData';
...
export default function PartnershipVerificationPage({ onBack, themeColor = '#ef4444' }) {
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden flex flex-col">
            ...
            <div className="max-w-4xl w-full mx-auto mb-8 relative z-10 text-center">
                <h1 className="text-2xl sm:text-3xl font-extrabold text-[#0C1A3A] tracking-tight">Partnership Verification</h1>
                    ...
                    >
                        <div className="bg-white p-8 sm:p-10 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] w-full max-w-md border border-slate-100">
                            ...
                            <form onSubmit={handleVerify} className="space-y-5">
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Organization / Person Name</label>
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Partnership Registration Number</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                            <FileText size={18} className="text-slate-400" />
                                        </div>
                    ...
                    >
                        ...
                        <div className="bg-white/60 backdrop-blur-xl border-b border-slate-100/80 p-8 sm:px-12 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 relative z-10">
                            <div className="flex items-center space-x-6">
                                <img src={partnershipDetails.partnershipDocumentPreview} alt="Preview" className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl object-cover shadow-sm ring-2 ring-white" style={{ borderColor: themeColor }} />
                                <div>
                                    <div className="flex flex-wrap items-center gap-4 mb-2">
                                        <h2 className="text-3xl sm:text-4xl font-black text-slate-800 tracking-tight">Partnership Details</h2>
                                        <span 
                        ...
                        <div className="p-8 sm:p-12 bg-slate-50/30 relative z-10">
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <InfoField icon={FileText} label="Sl No" value={partnershipDetails.slNo} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Partnership Registration Number" value={partnershipDetails.partnershipRegistrationNumber} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="First Organization Name" value={partnershipDetails.firstOrganizationName} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="First Organization Type" value={partnershipDetails.firstOrganizationType} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="First Organization Representative" value={partnershipDetails.firstOrganizationRepresentative} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="First Representative Designation" value={partnershipDetails.firstRepresentativeDesignation} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Second Organization Name" value={partnershipDetails.secondOrganizationName} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Second Organization Type" value={partnershipDetails.secondOrganizationType} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Second Organization Representative" value={partnershipDetails.secondOrganizationRepresentative} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Second Representative Designation" value={partnershipDetails.secondRepresentativeDesignation} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Partnership Title" value={partnershipDetails.partnershipTitle} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Partnership Type" value={partnershipDetails.partnershipType} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Partnership Purpose" value={partnershipDetails.partnershipPurpose} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Partnership Activity" value={partnershipDetails.partnershipActivity} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Partnership Start Date" value={partnershipDetails.partnershipStartDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Partnership End Date" value={partnershipDetails.partnershipEndDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Partnership Status" value={partnershipDetails.partnershipStatus} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Authorized Signatory" value={partnershipDetails.authorizedSignatory} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Signatory Designation" value={partnershipDetails.signatoryDesignation} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Mobile Number" value={partnershipDetails.mobileNumber} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Email ID" value={partnershipDetails.emailId} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Website" value={partnershipDetails.website} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Verification Date" value={partnershipDetails.verificationDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Verified By" value={partnershipDetails.verifiedBy} themeColor={themeColor} />
