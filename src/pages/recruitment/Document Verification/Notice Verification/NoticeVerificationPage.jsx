...
import { 
    User, Phone, Mail, Briefcase, Hash, CheckCircle, ArrowLeft, Search, ShieldAlert, Building, FileText, AtSign, UserCheck, AlertCircle
} from 'lucide-react';
                        ...
                        <div className="p-8 sm:p-12 bg-slate-50/30 relative z-10">
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                    ...
                                    <InfoField icon={FileText} label="Notice Date" value={noticeDetails.noticeDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Effective Date" value={noticeDetails.effectiveDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Expiry Date" value={noticeDetails.expiryDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Issuing Organization" value={noticeDetails.issuingOrganization} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Issuing Department" value={noticeDetails.issuingDepartment} themeColor={themeColor} />
                                    ...
                                    <InfoField icon={FileText} label="Address" value={noticeDetails.address} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Notice Status" value={noticeDetails.noticeStatus} themeColor={themeColor} />
