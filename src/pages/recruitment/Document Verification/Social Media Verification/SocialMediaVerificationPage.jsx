                    ...
                    >
                        ...
                        <div className="bg-white/60 backdrop-blur-xl border-b border-slate-100/80 p-8 sm:px-12 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 relative z-10">
                            <div className="flex items-center space-x-6">
                                <img src={socialMediaDetails.profilePhoto} alt="Preview" className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl object-cover shadow-sm ring-2 ring-white" style={{ borderColor: themeColor }} />
                                <div>
                                    <div className="flex flex-wrap items-center gap-4 mb-2">
                                        <h2 className="text-3xl sm:text-4xl font-black text-slate-800 tracking-tight">Social Media Details</h2>
                                        <span 
                        ...
                        <div className="p-8 sm:p-12 bg-slate-50/30 relative z-10">
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <InfoField icon={FileText} label="Sl No" value={socialMediaDetails.slNo} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Account Holder Name" value={socialMediaDetails.accountHolderName} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Username" value={socialMediaDetails.username} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Social Media Platform" value={socialMediaDetails.socialMediaPlatform} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Profile URL" value={socialMediaDetails.profileUrl} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Account ID" value={socialMediaDetails.accountId} themeColor={themeColor} />
                                    ...
                                    <InfoField icon={FileText} label="Organization Name" value={socialMediaDetails.organizationName} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Designation" value={socialMediaDetails.designation} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Registration Date" value={socialMediaDetails.registrationDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Followers" value={socialMediaDetails.followers} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Following" value={socialMediaDetails.following} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Verification Method" value={socialMediaDetails.verificationMethod} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Verified Badge Status" value={socialMediaDetails.verifiedBadgeStatus} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Contact Email" value={socialMediaDetails.contactEmail} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Mobile Number" value={socialMediaDetails.mobileNumber} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Website" value={socialMediaDetails.website} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Profile Status" value={socialMediaDetails.profileStatus} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Verification Date" value={socialMediaDetails.verificationDate} themeColor={themeColor} />
                                    <InfoField icon={FileText} label="Verified By" value={socialMediaDetails.verifiedBy} themeColor={themeColor} />
