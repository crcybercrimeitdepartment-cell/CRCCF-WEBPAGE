...
export default function StudentIDCardPage({ themeColor = '#2b7a8c' }) {
                    ...
                    >
                        <div className="bg-white p-8 sm:p-10 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] w-full max-w-lg border border-slate-100">
                            <div className="text-center mb-8">
                                ...
                                <h2 className="text-xl font-bold text-slate-800">Lookup Student ID Card</h2>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            placeholder="e.g. IDC-2024-STU23"
                                            required
                                        />
                                    </div>
                                </div>
