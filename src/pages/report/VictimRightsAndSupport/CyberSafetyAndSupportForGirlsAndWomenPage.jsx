...
import './cybersafetyandsupportforgirlsandwomenPage.css';
...
const Header = () => (
  <header className="cyber-safety-header">
    <h1>Cyber Safety and Support for Women & Girls</h1>
    <p>
...
export default function CyberSafetyAndSupportPage() {
  ...
  if (!isMobile) {
    ...
    return (
      <main className="cyber-safety-page" style={{ perspective: '2500px' }}>
        <Header />
  ...
  return (
    <main className="cyber-safety-page">
      <Header />
