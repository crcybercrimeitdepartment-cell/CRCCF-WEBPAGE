...
import pageData from "../../../data/report/VictimRightsAndSupport/../../../data/report/VictimRightsAndSupport/RightsOfCybercrimeVictimsEmpoweringYouwithCRCCFDataPage";
...
export default function RightsOfCybercrimeVictimsEmpoweringYouwithCRCCFPage() {
  const [isOpen, setIsOpen] = useState(false);
  const [currentPage, setCurrentPage] = useState(0);

  const folderColor = "bg-[#ebd3a8]";
  const folderBorder = "border-[#d8c3a1]";
