...
const SVG_05_Collaboration = () => (
    ...
    {[ {cx:25,cy:25}, {cx:75,cy:25}, {cx:50,cy:50}, {cx:25,cy:75}, {cx:75,cy:75} ].map((node,i) => <motion.circle initial={{ r: 0 }} key={i} {...node} r={0} fill="url(#metallic-blue)" initial={{r:0}} animate={{r:6}} transition={{delay: i*0.2}}><animate attributeName="r" values="6;8;6" dur="3s" begin={`${i*0.4}s`} repeatCount="indefinite" /></motion.circle>)}
