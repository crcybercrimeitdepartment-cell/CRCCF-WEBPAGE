...
const RecruitmentKeyboard = () => {
  ...
  const items = [
    ...
    { label: 'Document Verification Department', path: '/recruitment/document-verification-department', icon: Users, color: '#156a9a', desc: 'Exclusive portal for members to post new jobs.' },
