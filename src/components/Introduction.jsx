          ...
          <div className="flex items-center gap-[60px] max-[900px]:flex-col max-[900px]:gap-[32px] max-[600px]:gap-[24px]">
            ...
            >
              <div className="scale-[0.7] flex flex-col items-center max-[900px]:scale-[0.5] max-[600px]:scale-[0.4] max-[450px]:scale-[0.32] origin-center">
                <div className="rounded-[20px] shadow-[inset_0_0_0_2px_#c8cacb,inset_0_0_0_10px_#000] h-[318px] w-[518px] mx-auto py-[9px] px-[9px] pb-[23px] relative flex items-center justify-center bg-[linear-gradient(15deg,#3f51b1_0%,#5a55ae_13%,#7b5fac_25%,#8f6aae_38%,#a86aa4_50%,#cc6b8e_62%,#f18271_75%,#f3a469_87%,#f7c978_100%)] [transform-style:preserve-3d] [transform:perspective(1900px)_rotateX(-88.5deg)] [transform-origin:50%_100%] animate-[open_4s_infinite_alternate] after:bg-[linear-gradient(to_bottom,#272727,#0d0d0d)] after:rounded-[0_0_20px_20px] after:bottom-[2px] after:content-[''] after:h-[24px] after:left-[2px] after:absolute after:w-[514px]">
                  <div className="w-[100px] h-[12px] absolute bg-[#000] top-[10px] left-[50%] [transform:translate(-50%,-0%)] rounded-[0_0_6px_6px]"></div>
                  <img loading="lazy" decoding="async" src={Cloudinary.logoIile24} alt="CRCCF Logo" className="max-w-[55%] max-h-[55%] object-contain filter drop-shadow-[0_0_15px_rgba(255,255,255,0.4)] select-none pointer-events-none" />
                </div>
